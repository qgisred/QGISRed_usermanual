...
Ver el detalle completo del diálogo, qué se incluye y qué no, en [Guardar, exportar y cerrar proyecto](../../proyecto/proyecto-activo/guardar-backup.md#exportar-el-proyecto).

...
Once the project is created, the next step is to **build the network** using the **Edition** bar. See section [Editing and Modeling](../editing/) to see how to add pipes, nodes, and special elements.

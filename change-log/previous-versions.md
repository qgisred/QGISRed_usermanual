...
**Features**:
* Management of manual valves (import, creation, deletion, editing of properties, interaction with the status of the pipes...).
...
* The `demand multiplier` hydraulic option now supports decimals.

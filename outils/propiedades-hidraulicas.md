...
Attribue l'élévation (champ `Elevation`) aux nœuds, réservoirs et réservoirs du projet en interpolant leur valeur à partir d'un ou plusieurs Modèles Numériques de Terrain (MNT) au format ASC.

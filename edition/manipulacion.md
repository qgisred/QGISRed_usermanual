...
Déplace un ou plusieurs nœuds (Jonctions, Réservoirs, Réservoirs) en entraînant avec lui **tous les éléments linéaires connectés** (tuyaux, vannes, pompes). Le réseau reste connecté après le mouvement.
...
| Supprimer un réservoir ou un réservoir | L'élément est converti en jonction ou supprimé s'il n'a aucune connexion. |

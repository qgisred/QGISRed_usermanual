...
<figure><img src="../assets/images/instalacion/instalar-desde-zip.png" alt="Installation from ZIP"><figcaption><p>"Install from ZIP" tab of the QGIS plugin manager.</p></figcaption></figure>

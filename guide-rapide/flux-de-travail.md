...
- **Nouveau projet à partir de zéro** : _Créer un projet_ → choisissez le nom, le dossier et le système de référence. QGISRed génère automatiquement les 6 SHP de base (Jonctions, Tuyaux, Réservoirs, Bâches, Vannes, Pompes).
...
2. Ajoutez des **réservoirs et bâches** en cliquant sur les nœuds existants.

...
> 💡 La exportación del proyecto (ZIP portable) ya no está en esta barra: se hace desde el botón **Export** del Gestor de proyectos (ver [Guardar, Exportar y Cerrar Proyecto](../../proyecto/proyecto-activo/guardar-backup.md)).

...
* **Connect\_Links** (result of the Connectivity tool, within Queries): unlike the previous ones, it does not have rules by state — the color and size are applied directly to the symbol, as in any Single Symbol layer.

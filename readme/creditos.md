...
| Entidad            | Logo                                                                          |
| ------------------ | ----------------------------------------------------------------------------- |
| **Portal QGISRed** | [![Logo QGISRed](../.gitbook/assets/logo-qgisred.png)](http://qgisred.upv.es) |
| **REDHISP**        | ![Logo REDHISP](../.gitbook/assets/logo-redhisp.png)                          |
| **IIAMA**          | [![Logo IIAMA](../.gitbook/assets/logo-iiama.png)](http://www.iiama.upv.es)   |
| **UPV**            | [![Logo UPV](../.gitbook/assets/logo-upv.png)](http://www.upv.es)             |
...
QGISRed arranca en Nov 2018 con una **Ayuda de la Generalitat Valenciana (GV)** para la contratación de Personal de Apoyo a la Transferencia Tecnológica (APOTI/2018/006). Desde Julio 2019 la financión se cubre con **fondos propios del grupo REDHISP hasta la versión 0.17**.
...
| Entidad                                      | Logo                                                                    |
| -------------------------------------------- | ----------------------------------------------------------------------- |
| **Banco Interamericano de Desarrollo (BID)** | [![Logo BID](../.gitbook/assets/logo-bid.png)](https://www.iadb.org/es) |

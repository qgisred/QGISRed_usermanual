...
> Before simulating it is advisable to have passed the [topology and attribute checks](../debug/) to avoid convergence errors.
...
_Run model, Results browser and Status report share a drop-down button in the bar._

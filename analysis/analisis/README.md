...
> Antes de simular es recomendable haber pasado las [verificaciones de topología y atributos](../../debug/verificaciones/) para evitar errores de convergencia.
...
_Run model, Results browser y Status report comparten un botón desplegable en la barra._

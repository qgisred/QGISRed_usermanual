...
> **H** = presence of at least one Tank or Reservoir in the sector. **Q** = presence of at least one Junction with base demand > 0. **n** = negation (absence of that condition).

...
Una vez creado el proyecto, el siguiente paso es **construir la red** usando la barra de **Edition**. Consulta la sección [Edición y Modelado](../edicion/) para ver cómo añadir tuberías, nudos y elementos especiales.

...
LANGS = {
    "en": {
        ...
        "files": {
            ...
            "proyecto-activo/configuracion.md": "project-configuration.md",
            "ejecucion.md": "execution.md",
            "exportacion.md": "export.md",
            "perfiles-longitudinales.md": "longitudinal-profiles.md",
            "resultados.md": "results.md",
            "formatos.md": "formats.md",
            "changelog.md": "changelog.md",
            "consultas-propiedades.md": "property-queries.md",
            "estadisticas.md": "statistics.md",
            "explorador-elementos.md": "element-explorer.md",
            "mapas-tematicos.md": "thematic-maps.md",
            "controles.md": "controls.md",
            "creacion.md": "creation.md",
            "curvas.md": "curves.md",
            "edicion-por-grupo.md": "group-editing.md",
            "manipulacion.md": "manipulation.md",
            "propiedades.md": "properties.md",
            "acometidas.md": "service-connections.md",
            "sensores.md": "sensors.md",
            "abrir-importar.md": "open-import.md",
            "crear-proyecto.md": "create-project.md",
            "gestor-proyectos.md": "project-manager.md",
            "flujo-de-trabajo.md": "workflow.md",
            "toolbars.md": "toolbars.md",
            "constructor-sectores-demanda.md": "demand-sector-builder.md",
            "demandas-escenarios.md": "demands-and-scenarios.md",
            "propiedades-hidraulicas.md": "hydraulic-properties.md",
            "sectores-arbol.md": "sectors-tree.md",
            "dependencias.md": "dependencies.md",
            "desde-archivo-local.md": "from-local-file.md",
            "desde-repositorio.md": "from-repository.md",
            "requisitos.md": "requirements.md",
    ...
    "pt-BR": {
        ...
        "files": {
            ...
            "proyecto-activo/configuracion.md": "configuracao-do-projeto.md",
            "ejecucion.md": "execucao.md",
            "exportacion.md": "exportacao.md",
            "perfiles-longitudinales.md": "perfis-longitudinais.md",
            "resultados.md": "resultados.md",
            "formatos.md": "formatos.md",
            "changelog.md": "registro-de-mudancas.md",
            "consultas-propiedades.md": "consultas-propriedades.md",
            "estadisticas.md": "estatisticas.md",
            "explorador-elementos.md": "explorador-elementos.md",
            "mapas-tematicos.md": "mapas-tematicos.md",
            "controles.md": "controles.md",
            "creacion.md": "criacao.md",
            "curvas.md": "curvas.md",
            "edicion-por-grupo.md": "edicao-por-grupo.md",
            "manipulacion.md": "manipulacao.md",
            "propiedades.md": "propriedades.md",
            "acometidas.md": "ramais.md",
            "sensores.md": "sensores.md",
            "abrir-importar.md": "abrir-importar.md",
            "crear-proyecto.md": "criar-projeto.md",
            "gestor-proyectos.md": "gestor-projetos.md",
            "flujo-de-trabajo.md": "fluxo-de-trabalho.md",
            "toolbars.md": "barras-de-ferramentas.md",
            "constructor-sectores-demanda.md": "construtor-setores-demanda.md",
            "demandas-escenarios.md": "demandas-e-cenarios.md",
            "propiedades-hidraulicas.md": "propriedades-hidraulicas.md",
            "sectores-arbol.md": "setores-arvore.md",
            "dependencias.md": "dependencias.md",
            "desde-archivo-local.md": "a-partir-de-arquivo-local.md",
            "desde-repositorio.md": "a-partir-de-repositorio.md",
    ...
    "fr": {
        ...
        "files": {
            ...
            "proyecto-activo/configuracion.md": "configuration-du-projet.md",
            "ejecucion.md": "execution.md",
            "exportacion.md": "exportation.md",
            "perfiles-longitudinales.md": "profils-longitudinaux.md",
            "resultados.md": "resultats.md",
            "formatos.md": "formats.md",
            "changelog.md": "journal-des-modifications.md",
            "consultas-propiedades.md": "requetes-proprietes.md",
            "estadisticas.md": "statistiques.md",
            "explorador-elementos.md": "explorateur-elements.md",
            "mapas-tematicos.md": "cartes-thematiques.md",
            "controles.md": "controles.md",
            "creacion.md": "creation.md",
            "curvas.md": "courbes.md",
            "edicion-por-grupo.md": "edition-par-groupe.md",
            "manipulacion.md": "manipulation.md",
            "propiedades.md": "proprietes.md",
            "acometidas.md": "branchements.md",
            "sensores.md": "capteurs.md",
            "abrir-importar.md": "ouvrir-importer.md",
            "crear-proyecto.md": "creer-projet.md",
            "gestor-proyectos.md": "gestionnaire-projets.md",
            "flujo-de-trabajo.md": "flux-de-travail.md",
            "toolbars.md": "barres-outils.md",
            "constructor-sectores-demanda.md": "constructeur-secteurs-demande.md",
            "demandas-escenarios.md": "demandes-et-scenarios.md",
            "propiedades-hidraulicas.md": "proprietes-hydrauliques.md",
            "sectores-arbol.md": "secteurs-arborescence.md",
            "dependencias.md": "dependances.md",
            "desde-archivo-local.md": "depuis-fichier-local.md",
            "desde-repositorio.md": "depuis-depot.md",
            "requisitos.md": "prerequis.md",
            "creditos.md": "credits.md",
...
def remap_path(path: str, folder_map: dict, file_map: dict) -> str:
    """
    Translate folder segments via folder_map, and the filename via file_map.
    The filename lookup tries the full relative path first (e.g.
    "edicion/configuracion.md"), so two files that share a basename in
    different folders (e.g. edicion/configuracion.md vs
    proyecto-activo/configuracion.md) can get distinct translated names.
    Falls back to a bare-basename key when there is no collision to worry
    about, which keeps most "files" entries short.
    """
    norm = path.replace("\\", "/")
    parts = norm.split("/")
    folder_parts = [folder_map.get(p, p) for p in parts[:-1]]
    filename = file_map.get(norm, file_map.get(parts[-1], parts[-1]))
